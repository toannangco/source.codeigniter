<html><head>
    ...
    body{
        ...
        background-image:url(<?= admin_img?>404/o0vHoWv.gif);
        height:100%;
    }
    #level{
        width:100%;
    ...
    #gears-static{
        background:url(<?= admin_img?>404/FgFnjks.png) no-repeat -363px -903px;
        width:329px;
        height:602px;
        position:absolute;
        bottom:5px;
    ...
    /*gear-system-1*/
    #gear15{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -993px;
        width: 321px;
        height: 321px;
        position:absolute;
        left:45px;
    ...
    #gear14{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -856px;
        width: 87px;
        height: 87px;
        position:absolute;
        left:162px;
    ...
    #gear13{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -744px;
        width: 62px;
        height: 62px;
        position:absolute;
        left:174px;
    ...
    /*gear-system-2*/
    #gear10{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -184px;
        width: 122px;
        height: 122px;
        position:absolute;
        left:175px;
    ...
    #gear3{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -1493px;
        width: 85px;
        height: 84px;
        position:absolute;
        left:194px;
    ...
    /*gear-system-3*/
    #gear9{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat -371px -280px;
        width: 234px;
        height: 234px;
        position:absolute;
        left:197px;
    ...
    #gear7{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat -371px 0;
        width: 108px;
        height: 108px;
        position:absolute;
        left:260px;
    ...
    /*gear-system-4*/
    #gear6{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -1931px;
        width: 134px;
        height: 134px;
        position:absolute;
        left:305px;
    ...
    #gear4{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -1627px;
        width: 69px;
        height: 69px;
        position:absolute;
        left:337px;
    ...
    /*gear-system-5*/
    #gear12{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -530px;
        width: 164px;
        height: 164px;
        position:absolute;
        left:208px;
    ...
    #gear11{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -356px;
        width: 125px;
        height: 124px;
        position:absolute;
        left:228px;
    ...
    #gear8{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat -371px -158px;
        width: 72px;
        height: 72px;
        position:absolute;
        left:254px;
    ...
    /*gear1*/
    #gear1{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 0;
        width: 135px;
        height: 134px;
        position:absolute;
        left:83px;
    ...
    /*gear-system-6*/
    #gear5{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -1746px;
        width: 134px;
        height: 135px;
        position:absolute;
        left:22px;
    ...
    #gear2{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat 0 -1364px;
        width: 80px;
        height: 79px;
        position:absolute;
        left:49px;
    ...
    /*weight*/
    #weight{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat -371px -564px;
        width: 34px;
        height: 92px;
        position:absolute;
        left:1px;
    ...
    /*chain*/
    #chain-circle{
        background: url(<?= admin_img?>404/FgFnjks.png) no-repeat -371px -706px;
        width:146px;
        height:147px;
        position:absolute;
        left:17px;
...
<body>
<h1>Lỗi 404 !</h1>
<h2>Xin lỗi, trang bạn truy cập hiện không có.</h2>
<div id="level">
    <div id="content">
        <div id="gears">
