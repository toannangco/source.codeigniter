    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?= admin_url ?>post/"><?= danh_sach ?></a></li>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select name="post_parent" class="form-control">
                                    <?php $this->mmenu->dropDownMenu($formData['post']['post_parent'],'post'); ?>
                                </select>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <?php echo form_input(array('type' => 'text','class' => 'form-control post_lang_name_'.$value->lang, 'id' => 'post_lang_name',  'name' => 'post_lang_name_'.$value->lang, 'value' => $formData[$value->lang]['post_lang_name'], 'maxlength' => 70)); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12  ">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="form-control" name="post_lang_summary_<?= $value->lang?>" id="post_lang_summary_<?= $value->lang?>"><?= $formData[$value->lang]['post_lang_summary'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="form-control summernote" name="post_lang_detail_<?= $value->lang?>" id="post_lang_detail_<?= $value->lang?>"><?= $formData[$value->lang]['post_lang_detail'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" name="post_lang_seo_title_<?= $value->lang?>" id="post_lang_seo_title" value="<?= $formData[$value->lang]['post_lang_seo_title'] ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" name="post_lang_seo_keyword_<?= $value->lang?>" id="post_lang_seo_keyword" value="<?= $formData[$value->lang]['post_lang_seo_keyword'] ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" name="post_lang_seo_description_<?= $value->lang?>" id="post_lang_seo_description" value="<?= $formData[$value->lang]['post_lang_seo_description'] ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" name="news_view" id="news_view" value="<?= $formData['post']['post_view']?>" />
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="number" class="form-control" name="news_orderby" id="news_orderby" value="<?= $formData['post']['news_orderby']?>" />
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="input-group ">
                                ...
                                <div class="controls">
                                    <input type="checkbox" value="1" <?= $formData['post']['post_status'] == 1 ? "checked" : "" ?> name="post_status"> <i class="fa fa-eye"></i> <?= hien_thi?>
                                    <input type="checkbox" value="1" <?= $formData['post']['post_hot'] == 1 ? "checked" : "" ?> name="post_hot"> <i class="fa fa-trophy"></i> <?= noi_bat?>
                                    <!-- <input type="checkbox" value="1" <?= $formData['post']['news_home'] == 1 ? "checked" : "" ?> name="news_home"> <i class="fa fa-home"></i> <?= trang_chu?> -->
                                    <!-- <input type="checkbox" value="1" <?= $formData['post']['news_comment'] == 1 ? "checked" : "" ?> name="news_comment"> <i class="fa fa-comment"></i> <?=binh_luan?> -->
                                </div>
                            </div>
                        </div>
                    </div>
                   <!--  <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" name="news_video" id="news_video" value="<?= $formData['post']['news_video']?>" placeholder="Ví dụ: https://www.youtube.com/watch?v=d9sKAPexIlk" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" name="news_create_date" id="news_create_date" value="<?= $formData['post']['news_create_date']?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="clr"></div> -->
                    ...
                    <!-- <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <ul class="">
                            <?php
                            if($formData['post']['news_file'])
                            {
                                echo '<li>'.$formData['post']['news_file'].' <span class="text-danger"><input type="checkbox" name="removefile" value="1"> <i class="fa fa-trash-o"></i> Trash</span></li>';
                            }
                            ?>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <ul class="">
                            <?php
                            if($formData['post']['news_file2'])
                            {
                                echo '<li>'.$formData['post']['news_file2'].' <span class="text-danger"><input type="checkbox" name="removefile2" value="1"> <i class="fa fa-trash-o"></i> Trash</span></li>';
                            }
                            ?>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="col-lg-12"><input type="file" name="post_picture" class="form-control mb10"></div>
                            </div>

                            <ul class="mulpic_ser">
                            <?php
                            if($formData['post']['post_picture'])
                            {
                                echo '<li><img src="'.base_file.'post/'.$formData['post']['post_picture'].'" width="100"  height="100"/><span class="text-danger"><input type="checkbox" name="removepicture" value="1"> <i class="fa fa-trash-o"></i> Trash</span></li>';
                            }
                            ?>
                            </ul>
                        </div>
