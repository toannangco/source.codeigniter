                    ...
                    <div class="box box-solid">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title"><?= hop_thu_den?></h3>
                                    </div>
                                    <!-- compose message btn -->
                                    ...
                                    <div style="margin-top: 15px;">
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?= admin_url?>mailto/index/"><i class="fa fa-inbox"></i> <?= hop_thu_den?> (<?= $record_inbox?>)</a></li>
                                            ...
                                            <li><a href="<?= admin_url?>mailto/trash/"><i class="fa fa-trash-o"></i> <?= thung_rac?> (<?= $record_trash?>)</a></li>
                                            <!--<li><a href="#"><i class="fa fa-pencil-square-o"></i> Drafts</a></li>-->
                                            <!--<li class="active"><a href="<?= admin_url?>mailto/send/"><i class="fa fa-mail-forward"></i> Sent</a></li>-->
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <button name="deleteCheckAll" class="btn-dropdown"><i class="fa fa-trash-o"></i> <?= bo_vao_thung_rac?></button>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <table class="table table-mailbox table-checkbox">
                                            ...
                                            <?php if($list){
                                                ...
                                                foreach($list as $item){
                                                    ...
                                                    $list_user_full =  "";
                                                    $list_user =  (isset($item['mailto_send_list_user']) && $item['mailto_send_list_user'])?json_decode($item['mailto_send_list_user']):'';
                                                    if($list_user && count($list_user)>1){
                                                        foreach($list_user as $ik){
                                                            $list_user_full .= $ik.', ';
                                                        }
                                                        $list_user_full = rtrim($list_user_full,", ");
                                                    }
                                                    ?>
                                                    <tr class="">
                                                        <td class="small-col"><input type="checkbox" class="checkbox_item" name="check_all[]" value="<?= $item["id"]?>"></td>
                                                        <td class="name" >
                                                            <strong title="<?= $list_user_full;?>"><?= $list_user[0]?></strong>
                                                        </td>
                                                        <td class="subject">
                                                            <a href="<?= $link_info?>">
                                                                <?= (isset($item['mailto_send_title']) && $item['mailto_send_title'])?$item['mailto_send_title']:''?>
                                                                <small class="text-gray"><?= (isset($item['mailto_send_content']) && $item['mailto_send_content'])?'- '.substring(strip_tags($item['mailto_send_content']),100):''?></small>
                                                            </a>
                                                        </td>
                                                        <td class="time" title="<?= (isset($item['mailto_send_create_date']) && $item['mailto_send_create_date'])?date("d/m/Y h:i:s a",$item['mailto_send_create_date']):'';?>">
                                                            <?php
                                                            if( (isset($item['mailto_send_create_date']) && $item['mailto_send_create_date'])){
                                                                if(date("d")==date("d",$item["mailto_send_create_date"])){
                                                                    echo date("h:i a",$item['mailto_send_create_date']);
                                                                    echo ' <i class="fa fa-clock-o" style="cursor: help;"></i>';
                                                                }else{
                                                                    echo date("d M",$item['mailto_send_create_date']);
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                ...
                                <li class="disabled"><a><?= tat_ca?>: <?= $record_send?> email</a></li>
                            </ul>
                        </div>
                        <!-- END: Box-Footer -->
                    </div><!-- /.box -->
