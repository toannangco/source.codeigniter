                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title"> Đăng ký nhận mail</h3>
                                    </div>
                                    <!-- compose message btn -->
                                    ...
                                    <div style="margin-top: 15px;">
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li class="active"><a href="<?= admin_url?>mailto/customer/" title="<?= $record_read?> mail chưa đọc"><i class="fa fa-inbox"></i> Đăng ký nhận mail</a></li>
                                            <li><a href="<?= admin_url?>mailto/trash/" title="<?= $record_trash?> mail chưa đọc"><i class="fa fa-trash-o"></i> <?= thung_rac?> (<?= $record_trash?>)</a></li>
                                    ...
                                    <div class="row pad">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="<?= admin_url?>mailto/customer_send/" class="btn btn-primary">Gửi mail tất cả</a>
                                            ...
                                            <?php if($list){
                                                ...
                                                foreach($list as $item){
                                                    ...
                                                    <tr class="<?= $unread?>">
                                                        ...
                                                        <td class="subject">
                                                            <a href="<?= $link_info?>">                                                                
                                                                <small class="text-gray"><?= (isset($item['mailto_email']) && $item['mailto_email'])? substring(strip_tags($item['mailto_email']),100):''?></small>
                                                            </a>
                                                        </td>
