                    ...
                    <div class="box box-solid box-primary">
                        <div class="box-header">
						   ...
						   <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea name="<?=$file?>" id="<?=$file?>" class="summernote_contact form-control" >
                                        <?= $data[$file]; ?>
                                    </textarea>
                                </div>
                            </div> 
							...
							<div class="control-group col-md-6 col-xs-6 col-md-offset-3" style="min-height:300px;">
                                ...
                                <div class="controls addClass">
								  ...
								  <?php if(count($data['website_congdong_class'])) { 	
									  for($i=0;$i< count($data['website_congdong_class']);$i++) {
									  ?>
									
		Tên lớp :		<input type='text' name='website_congdong_class[]' value="<?=$data['website_congdong_class'][$i]?>"  class='class form-control'/> 
											<?php }
										}
									 ?>
                                </div>
